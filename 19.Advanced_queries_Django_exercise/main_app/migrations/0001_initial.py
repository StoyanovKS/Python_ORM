# Generated by Django 5.1.2 on 2024-11-08 19:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('release_year', models.PositiveIntegerField(validators=[main_app.validators.RangeValueValidator(1990, 2023, message='The release year must be between 1990 and 2023')])),
                ('rating', models.DecimalField(decimal_places=1, max_digits=2, validators=[main_app.validators.RangeValueValidator(0, 10, message='The rating must be between 0.0 and 10.0')])),
            ],
        ),
        migrations.CreateModel(
            name='Invoice',
